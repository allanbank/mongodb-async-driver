 ...
 */
/* package */class OneThreadTransport
        extends AbstractSocketTransport<OneThreadOutputBuffer>
        implements Receiver {
     ...
     */
    public OneThreadTransport(final Server server,
            ...
            final ThreadLocal<Reference<OneThreadOutputBuffer>> buffers)
                    throws IOException {
     ...
     */
    @Override
    public OneThreadOutputBuffer createSendBuffer(final int size) {
     ...
     */
    @Override
    public void send(final OneThreadOutputBuffer buffer) throws IOException {
        try {
    ...
    protected OneThreadOutputBuffer createIsMasterBuffer() throws IOException {
        final OneThreadOutputBuffer buffer = new OneThreadOutputBuffer(
                myEncoderCache);
