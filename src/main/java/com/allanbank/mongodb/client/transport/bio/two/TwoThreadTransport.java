 ...
 */
/* package */class TwoThreadTransport
        extends AbstractSocketTransport<TwoThreadOutputBuffer>
        implements Receiver {
     ...
     */
    public TwoThreadTransport(final Server server,
            ...
            final ThreadLocal<Reference<TwoThreadOutputBuffer>> buffers)
                    throws IOException {
        ...
        final int localPort = mySocket.getLocalPort();
     ...
     */
    @Override
    public void close(final MongoDbException error) throws IOException {
     ...
     */
    @Override
    public TwoThreadOutputBuffer createSendBuffer(final int size) {
     ...
     */
    @Override
    public void send(final TwoThreadOutputBuffer buffer)
            throws InterruptedIOException {
        try {
            for (final PendingMessage toSend : buffer.getMessages()) {
    ...
    protected TwoThreadOutputBuffer createIsMasterBuffer() {
        final TwoThreadOutputBuffer buffer = new TwoThreadOutputBuffer();
