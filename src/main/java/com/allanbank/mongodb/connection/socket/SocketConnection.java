...
public class SocketConnection implements Connection {
    ...
    public Reply read() throws MongoDbException {
        try {
            ...
            return new Reply(responseTo, cursorId, startingIndex, results,
                    (flags & Reply.AWAIT_CAPABLE_BIT) == Reply.AWAIT_CAPABLE_BIT,
                    (flags & Reply.CURSOR_NOT_FOUND_BIT) == Reply.CURSOR_NOT_FOUND_BIT,
                    (flags & Reply.QUERY_FAILURE_BIT) == Reply.QUERY_FAILURE_BIT,
                    (flags & Reply.SHARD_CONFIG_STALE_BIT) == Reply.SHARD_CONFIG_STALE_BIT);
        }
