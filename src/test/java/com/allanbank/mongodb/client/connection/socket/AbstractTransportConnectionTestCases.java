...
import com.allanbank.mongodb.client.PoisonMessage;
...
public abstract class AbstractTransportConnectionTestCases {
    ...
    /** The collector for the connection metrics. */
    protected ConnectionMetricsCollector myCollector;

    /** The test connection. */
    protected TransportConnection myTestConnection = null;
     ...
     */
    @Test
    public void testRaiseError() throws IOException {
        // Don't run on travis.
        assumeThat(getenv("TRAVIS"), not(is("true")));
     ...
     */
    @Test
    public void testTransportConnection() throws IOException {
     ...
     */
    @Test
    public void testTransportConnectionFailure() throws IOException {
     ...
     */
    protected abstract void connect(final Server server,
    ...
    private void connect() throws SocketException, IOException {
        connect(new MongoClientConfiguration());
    }
     ...
     *             On a failure talking to the server.
     */
    private void connect(final MongoClientConfiguration config)
            throws SocketException, IOException {
        connect(myTestServer, config);
    }
