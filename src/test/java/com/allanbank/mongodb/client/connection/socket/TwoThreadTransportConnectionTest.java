 ...
 * {@link TwoThreadTransportFactory}.
 * 
 * @copyright 2011-2015, Allanbank Consulting, Inc., All Rights Reserved
 */
public class TwoThreadTransportConnectionTest extends
		AbstractTransportConnectionTestCases {
	...
	protected void connect(final Server server,
		...
		TransportFactory factory = new TwoThreadTransportFactory();
		Transport<TransportOutputBuffer> transport = (Transport<TransportOutputBuffer>) factory
