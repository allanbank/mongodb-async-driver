...
public class BatchedWriteCallbackTest {
	...
	public void testBatchedWriteUsingWriteCommands() {
		...
		BatchedWriteCallback cb = new BatchedWriteCallback(databaseName,
		...
		Capture<ReplyCallback> capture1 = new Capture<ReplyCallback>();
		Capture<ReplyCallback> capture2 = new Capture<ReplyCallback>();
		Capture<ReplyCallback> capture3 = new Capture<ReplyCallback>();
	...
	public void testBatchedWriteUsingWriteCommandsReplyFailure() {
		...
		// Now the results.
		Capture<Throwable> caughtError = new Capture<Throwable>();
		reset(mockResults, mockClient);
		...
		assertThat(batchError.getErrors().keySet().iterator().next(), is(write
				.getWrites().get(0)));
		Throwable t = batchError.getErrors().values().iterator().next();
	...
	public void testBatchedWriteUsingWriteCommandsFailure() {
		...
		Throwable error = new Throwable("Something bad happened.");
