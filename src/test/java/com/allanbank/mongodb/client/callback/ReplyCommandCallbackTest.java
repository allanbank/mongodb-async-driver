/*
 * #%L
 * ReplyCommandCallbackTest.java - mongodb-async-driver - Allanbank Consulting, Inc.
 * %%
...
public class ReplyCommandCallbackTest {
    ...
    /**
     * Test method for {@link ReplyCommandCallback#asError(Reply)} .
     */
    ...
    public void testAsErrorMoreThan1Doc() {
        ...
        final ReplyCommandCallback callback = new ReplyCommandCallback(
                mockCallback);
    ...
    public void testAsErrorWithOk() {
        final List<Document> docs = Collections.singletonList(BuilderFactory
                .start().addInteger("code", -23).build());
        ...
        final ReplyException error = (ReplyException) callback.asError(reply,
                true);
        assertEquals(-23, error.getErrorNumber());
    ...
    /**
     * Test method for {@link ReplyCommandCallback#convert(Reply)}.
     */
    @SuppressWarnings("unchecked")
    @Test
