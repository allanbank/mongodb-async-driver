/*
 * #%L
 * ElementTypeTest.java - mongodb-async-driver - Allanbank Consulting, Inc.
 * %%
...
public class ElementTypeTest {
    ...
    public void testCompareWithDbPointer() {
        ...
        assertTrue(ElementType.DB_POINTER.compare(ElementType.MONGO_TIMESTAMP) > 0);
    ...
    public void testCompareWithJavaScript() {
        ...
        assertTrue(ElementType.JAVA_SCRIPT.compare(ElementType.MONGO_TIMESTAMP) > 0);
    ...
    public void testCompareWithJavaScriptWithScope() {
        ...
        assertTrue(ElementType.JAVA_SCRIPT_WITH_SCOPE.compare(ElementType.NULL) > 0);
        assertTrue(ElementType.JAVA_SCRIPT_WITH_SCOPE
                .compare(ElementType.DOUBLE) > 0);
        assertTrue(ElementType.JAVA_SCRIPT_WITH_SCOPE.compare(ElementType.LONG) > 0);
        assertTrue(ElementType.JAVA_SCRIPT_WITH_SCOPE
    ...
    public void testCompareWithLong() {
        ...
        assertTrue(ElementType.LONG.compare(ElementType.JAVA_SCRIPT_WITH_SCOPE) < 0);
    ...
    public void testCompareWithMongoTimestamp() {
        ...
        assertTrue(ElementType.MONGO_TIMESTAMP.compare(ElementType.DB_POINTER) < 0);
        assertTrue(ElementType.MONGO_TIMESTAMP.compare(ElementType.JAVA_SCRIPT) < 0);
        assertTrue(ElementType.MONGO_TIMESTAMP
                .compare(ElementType.JAVA_SCRIPT_WITH_SCOPE) < 0);
    ...
    public void testCompareWithNull() {
        ...
        assertTrue(ElementType.NULL.compare(ElementType.JAVA_SCRIPT_WITH_SCOPE) < 0);
    ...
    public void testCompareWithTimestamp() {
        ...
        assertTrue(ElementType.UTC_TIMESTAMP.compare(ElementType.UTC_TIMESTAMP) == 0);
