...
public class ArrayElementTest {
    ...
    public void testEqualsHashCode() {
        ...
        List<ArrayElement> objs1 = new ArrayList<ArrayElement>();
        List<ArrayElement> objs2 = new ArrayList<ArrayElement>();
    ...
    public void testQueryPathWithEmptyPathMatchingType() {
        ...
        ArrayElement element = new ArrayElement("foo", new BooleanElement("1",
                false));
        ...
        List<ArrayElement> arrayElements = element
    ...
    public void testQueryPathWithPathMatchingSubelement() {
        ...
        ArrayElement element = new ArrayElement("foo", subElement);
